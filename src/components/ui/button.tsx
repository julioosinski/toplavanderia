...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-gradient-primary text-primary-foreground shadow hover:scale-105 active:scale-95 transition-bounce",
        destructive:
        ...
        fresh: "bg-gradient-fresh text-white shadow-glow hover:scale-105 active:scale-95 transition-bounce",
        clean: "bg-card text-card-foreground border border-border hover:shadow-card transition-smooth",
      },
      size: {
