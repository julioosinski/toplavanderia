...
Envie: `releases/TopLavanderia-Totem-2.2.122-cielo.apk` (Stone Deeplink + sessões de pagamento)
...
|---------|-------------|-----|
| `TopLavanderia-Totem-2.2.122-cielo.apk` | 2.2.122 | **Atual** — Stone Deeplink (pay/cancel) + Cielo sessions |
